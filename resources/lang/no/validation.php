...
return [
    ...
    */
    ...
    'failed' => [
        'update' => 'Kunne ikke oppdatere ":name".'
    ],

    'succeeded' => [
        'create' => 'Vellykket oppretting av ":name".',
        'update' => 'Vellykket oppdatering av ":name".',
        'delete' => 'Vellykket sletting av ":name".'
    ],
    ...
    */
    ...
    'attributes' => [
        ...
        'lastnames' => 'etternavn',
        'emails' => 'e-poster',
        'check_in_day' => 'innsjekksdato - dag',
        'check_in_month' => 'innsjekksdato - måned',
        'check_in_year' => 'innsjekksdato - år',
        'check_out_day' => 'utsjekksdato - dag',
        'check_out_month' => 'utsjekksdato - måned',
        'check_out_year' => 'utsjekksdato - år',
        'people' => 'personer',
        'check_in_date' => 'innsjekksdato',
        'check_out_date' => 'utsjekksdato',
        'special_wishes' => 'spesielle ønsker',
        'room_people' => 'rom personer',
        'parking_people' => 'parkering personer',
        'rooms' => 'rom',
        'parking' => 'parkering',
        'meals' => 'måltider'
    ],
